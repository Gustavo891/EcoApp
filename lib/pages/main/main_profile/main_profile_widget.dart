import '/auth/empty_state_simple/empty_state_simple_widget.dart';
import '/auth/firebase_auth/auth_util.dart';
import '/backend/backend.dart';
import '/components/navbar/navbar_widget.dart';
import '/components/outros/user_list/user_list_widget.dart';
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              if (socialFeedUserPostsRecord.postPhoto != null && socialFeedUserPostsRecord.postPhoto != '' ? true : false)
                                                                                ClipRRect(
                                                                                  borderRadius: BorderRadius.circular(0.0),
                                                                                  child: CachedNetworkImage(
                                                                                    fadeInDuration: Duration(milliseconds: 500),
                                                                                    fadeOutDuration: Duration(milliseconds: 500),
                                                                                    imageUrl: socialFeedUserPostsRecord.postPhoto,
