                      ...
                      children: [
                        ...
                        Theme(
                          ...
                          child: CheckboxListTile(
                            ...
                            subtitle: Text(
                              'Clique na checkbox ao lado caso seja um quiz especial.',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'Figtree',
                        ...
                        onPressed: () async {
                          await QuizSetRecord.collection
                              ...
                              .set(createQuizSetRecordData(
                                ...
                                especial: _model.checkboxListTileValue,
                                dataFinalEspecial: _model.datePicked,
                              ));
                        },
                        text: 'CRIAR SET',
                        icon: Icon(
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return InkWell(
                                ...
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    ...
                                    'total': serializeParam(
                                      listViewQuizSetRecord.totalQuestoes,
                                      ParamType.int,
                                    ),
                                  }.withoutNulls,
                                );
                              ...
                              child: QuizCardWidget(
                                key: Key(
                                    'Key8uo_${listViewIndex}_of_${listViewQuizSetRecordList.length}'),
