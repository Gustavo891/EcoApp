  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AdminRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AdminRecord> criarContaAdminRecordList = snapshot.data!;
        final criarContaAdminRecord = criarContaAdminRecordList.isNotEmpty
            ? criarContaAdminRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
